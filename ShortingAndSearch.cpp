...
//melakukan metode pencarian tengah / bagi dua
...
//memanggil fungsi dari pengurutan dan pencarian
int main(int argc, char *argv[]) {
	...
	cout << "mencari nilai index -> 0 = " 
	<< binarySearch (data, 0, 6, 0) << endl;
	cout << "mencari nilai index -> 1 = "
	<< binarySearch (data, 0, 6, 1) << endl;
	cout << "mencari nilai index -> 2 = "
	<< binarySearch (data, 0, 6, 2)<< endl;
	cout << "mencari nilai index -> 3 = "
	<< binarySearch (data, 0, 6, 3) << endl;
	cout << "mencari nilai index -> 4 = "
	<< binarySearch (data, 0, 6, 4) << endl;
	cout << "mencari nilai index -> 5 = "
	<< binarySearch (data, 0, 6, 5) << endl;
	cout << "mencari nilai index -> 6 = "
	<< binarySearch (data, 0, 6, 6) << endl;
	cout << "mencari nilai index -> 7 = " 
	<< binarySearch (data, 0, 6, 7) << endl;
	cout << "mencari nilai index -> 8 = "
	<< binarySearch (data, 0, 6, 8) << endl;
	cout << "mencari nilai index -> 9 = "
	<< binarySearch (data, 0, 6, 9) << endl;
     return 0;
}